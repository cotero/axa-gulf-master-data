...
/**
 * Provides the local service interface for Vehicle_Catalogue. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see Vehicle_CatalogueLocalServiceUtil
...
public interface Vehicle_CatalogueLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link Vehicle_CatalogueLocalServiceUtil} to access the vehicle_ catalogue local service. Add custom service methods to {@link com.axa.glf.masterdata.service.impl.Vehicle_CatalogueLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
